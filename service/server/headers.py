...
# TODO(jessime) Decide if this should be writen as a single dict.
# For manual editing, it may or may not be easier to keep the components
# separate.
VEP_DESCRIPTIONS = {
...
# TODO(jessime) These types are not necessarily correct.
VEP_TYPES = {
    'AA_AF': 'float',
    'AF': 'string',
    'AFR_AF': 'float',
